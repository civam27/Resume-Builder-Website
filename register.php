...
<body>
            ...
            <div class="card-header">
                <div class="logo-container">
                    ...
                    <div>
                        ...
                        <p class="app-tagline">Create your professional account</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <form method="post" action="actions/register.action.php">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="full_name" id="fullName" placeholder=" " required>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Check if inputs have value on page load
